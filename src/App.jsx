...
function App() {
  ...
  return (
    <div className="App mx-auto">
      ...
      >
        <nav className="container relative md:mx-auto p-10">
      ...
      <div className="container relative mx-auto">
        <div className="container shadow-lg flex flex-col-reverse md:flex-row items-center mx-auto my-20">
          ...
          <div className="items-center ml-auto ">
            <img
              className="md:h-96 object-contain md:p-5"
              src="./src/assets/imgs/profileimg.png"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="container relative mx-auto">
        <div className="container shadow-lg flex flex-col-reverse md:flex-row items-center mx-auto my-20">
          <div className="p-5 md:w-100">
            <div className="items-center ">
              <div className="flex flex-row justify-center ">
                <svg
                  className="h-20 w-20 object-contain m-1 fill-blue-500"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className="bg-cover h-20 w-20 object-contain m-1 fill-blue-500"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="items-center ml-auto p-10">
            <p>
              ...
              consequatur, in reprehenderit earum soluta necessitatibus
              reiciendis ab! Aliquam hic eius eaque eum quae rem dignissimos
              praesentium amet animi voluptates. Quaerat possimus quibusdam
              reprehenderit ex veritatis, officia voluptatum, molestias sequi
              accusantium vero voluptate iure? Molestias id reprehenderit quia
              eligendi veritatis dolore. Culpa pariatur odio laboriosam?
            </p>
          </div>
        </div>
      </div>
      <div className="container relative mx-auto">
        <div className="container shadow-lg flex flex-col items-center mx-auto my-20">
          ...
          <div className="w-4/5 p-10 pt-0">
            ...
            >
              <SwiperSlide>
                <div className="bg-hero bg-cover h-64 object-contain"></div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="bg-hero bg-cover h-64 object-contain"></div>
              </SwiperSlide>
          ...
          <div className="w-4/5 p-10 pt-0">
            <div id="contactForm">
              <form id="contact" className="flex flex-col">
                ...
                ></textarea>
                <button className="bg-iceWhite p-4 md:w-2/3 justify-center mx-auto mt-10 my-0 font-handwritten font-bold text-xl md:text-2xl">
                  📨 Send me a message!
                </button>
              </form>
            </div>
